...
export const PROVIDERS_MANIFEST_ENTRY: BunTestWorkspaceEntry = {
  workspace: 'providers',
  files: [
    ...
    'src/anthropic/AnthropicMessageNormalizer.toolFailure.test.ts',
    ...
    'src/gemini/GeminiMessageConverter.toolFailure.test.ts',
    ...
    'src/openai-responses/OpenAIResponsesProvider.websocketFallback.test.ts',
    'src/openai-responses/OpenAIResponsesProviderCore.fetchRetry.test.ts',
    'src/openai-responses/openAIResponsesWebSocketTransport.closeDispatch.test.ts',
    ...
    'src/openai/OpenAIRequestBuilder.toolFailure.test.ts',
    ...
    'src/utils/toolResponsePayload.toolFailure.test.ts',
