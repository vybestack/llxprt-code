...
describe('scripts/build_sandbox.js', () => {
  ...
  it('packs tools, settings, telemetry, MCP, and providers alongside core and CLI', () => {
...
describe('Dockerfile', () => {
  ...
  it('copies tools, settings, telemetry, MCP, core, providers, and CLI tarballs in dependency order', () => {
