...
/**
 * f1-neutral-content-number.ts — Finding #2 adversarial FAIL (must pass) fixture.
 *
 * Contains a neutral domain object: `{candidates:[{content:42}]}`.
 * Here `content` is a number, NOT an object with `role` or `parts`.
