 ...
 * Example Zed config:
 *   "command": "node",
 *   "args": ["scripts/acp-logging-proxy.ts", "--", "bun", "packages/cli/index.ts", "--experimental-acp", ...]
 */
...
function logEntry(direction: string, data: Buffer | string) {
  const raw = typeof data === 'string' ? data : data.toString();
  let entry: RawLogEntry | ParsedLogEntry = {
