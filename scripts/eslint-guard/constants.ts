...
export function isGeneratedGuardFixture(file: string) {
  return (
...
export function startsWithAddedContent(line: string) {
  return line.startsWith('+') && !line.startsWith('+++');
}

export function startsWithRemovedContent(line: string) {
  return line.startsWith('-') && !line.startsWith('---');
}

export function addedContent(line: string) {
  return line.slice(1);
}

export function removedContent(line: string) {
  return line.slice(1);
}

export function isAllowedPolicyOff(line: string) {
  return line.includes('eslint-policy-allow-off:');
}

export function isNewOffRule(line: string) {
...
export function isCommentOnlyLine(line: string) {
