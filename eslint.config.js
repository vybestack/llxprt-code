...
export default tseslint.config(
  {
    ...
    ignores: [
      ...
      'eslint.config.js',
      'packages/**/dist/**',
      // Issue #2628: the non-workspace plugins build to dist like packages do;
  ...
  // Issue #2628: the plugins/* lane is linted by this root config (the plugins
  // have no local eslint config) but sits outside packages/, so the
  // packages/*/src block above does not reach it. Mirror that block's runtime
  // globals and leading-underscore unused-var tolerance. No parser/project
  // settings are needed here: tseslint.configs.recommended already supplies
  // the TypeScript parser and this lane enables no type-aware rules.
  {
