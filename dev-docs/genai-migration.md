...
| `SafetySetting`, `MediaResolution`, `ModelSelectionConfig`, `GenerationConfigRoutingConfig`, `SpeechConfigUnion`                                                                                                                             | **Stay Gemini-only** (`packages/providers/src/gemini/**`). Never get neutral equivalents.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
- **Code Assist wrapper deletion:** #2623 deleted the core wrapper and direct Gemini fallback. The Gemini provider retains its own SDK client.
