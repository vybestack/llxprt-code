...
- **License**: Moonshot Kimi K3 license (see upstream model card)
...
- **Conversion**: HuggingFace BPE vocabulary converted to tiktoken BPE rank
  format via the standard GPT-2 byte-to-unicode inverse mapping
- **License**: MiniMax Community License (nonstandard — see upstream model
  card for terms, including production-use restrictions)
