...
describe('AllBucketsExhaustedError @plan:PLAN-20260223-ISSUE1598.P07', () => {
   ...
   * Contract behavior: construct with 3 params and default bucketFailureReasons to an empty object.
   */
  it('constructs with 3 parameters using default bucket failure reasons', () => {
    // Arrange
