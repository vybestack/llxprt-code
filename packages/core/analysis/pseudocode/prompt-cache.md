...
1. Create new cache instance
   ...
   c. Set maxSize to maxSizeMB _ 1024 _ 1024
   d. Set accessOrder to empty linked list

2. Validate configuration
   a. IF maxSizeMB <= 0:
   - Set maxSize to 100 _ 1024 _ 1024 (100MB default)
     b. IF maxSizeMB > 1000:
   - Set maxSize to 1000 _ 1024 _ 1024 (1GB limit)
...
1. Calculate statistics
   ...
   b. Set totalSizeMB = totalSize / (1024 _ 1024)
   c. Set utilizationPercent = (totalSize / maxSize) _ 100
