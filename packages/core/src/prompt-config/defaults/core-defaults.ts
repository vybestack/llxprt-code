 ...
 * These constants contain the default content for core system prompts
 */

export const CORE_DEFAULTS: Record<string, string> = {
  'core.md': `You are an interactive CLI agent specializing in software engineering tasks. Your primary goal is to help users safely and efficiently, adhering strictly to the following instructions and utilizing your available tools.
