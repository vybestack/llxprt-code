...
describe('AnthropicProvider', () => {
  ...
  describe('Prompt Caching', () => {
    ...
    describe('Folder Structure Exclusion', () => {
      it('should exclude folder structure from system prompt when include-folder-structure is false', async () => {
        settingsService.setProviderSetting(
          'anthropic',
          'prompt-caching',
          'off',
        );
        settingsService.set('include-folder-structure', false);
        ...
        // Should not contain folder structure indicators
        expect(systemPrompt).not.toMatch(/folder.*structure/i);
        expect(systemPrompt).not.toMatch(/├───|└───/);
      });

      it('should include folder structure from system prompt when include-folder-structure is true', async () => {
        settingsService.setProviderSetting(
          'anthropic',
          'prompt-caching',
          'off',
        );
        settingsService.set('include-folder-structure', true);
        ...
        // Should contain folder structure indicators (or be present)
        // Note: In tests, folder structure might not generate due to mocking,
        // so we just verify the setting was applied
