 ...
 * runtime file lookup — it predates the move to Bun-run TypeScript source
 * and is retained because it is still the most reliable way to ensure the
 * schema is loaded before Ajv validation runs.
 *
