...
describe('shell-parser prompt transform detection', () => {
...

  {
    ...
    it('should detect ${var@P} prompt transform', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not treat lowercase ${var@p} as a prompt transform', () => {
      const tree = parseShellCommand('echo ${foo@p}');
      expect(tree).not.toBeNull();
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should detect ${var@P} in a complex command', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should detect ${var@P} in a chained command', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should detect ${var@P} inside command substitution', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should detect ${var@P} inside backtick command substitution', () => {
      const tree = parseShellCommand('echo `printf %s ${x@P}`');
      expect(tree).not.toBeNull();
      expect(hasPromptCommandTransform(tree!.rootNode)).toBe(true);
    });
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should detect multiple prompt transforms in one command', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should reject prompt transforms through parseCommandDetails', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should reject prompt transforms in assignment context', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not reject default-value text that contains @P without a transform operator', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not detect a plain expansion as a prompt transform', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not detect another parameter transform such as ${var@Q}', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should reject invalid ${@P} special-parameter syntax via parse errors', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not detect a trailing at-sign transform as a prompt transform', () => {
      const tree = parseShellCommand('echo ${foo@}');
      expect(tree).not.toBeNull();
      expect(hasPromptCommandTransform(tree!.rootNode)).toBe(false);
    });
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not detect a double at-sign transform as a prompt transform', () => {
      const tree = parseShellCommand('echo ${foo@@P}');
      expect(tree).not.toBeNull();
      expect(hasPromptCommandTransform(tree!.rootNode)).toBe(false);
    });
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not detect a simple command as a prompt transform', () => {
...
describe('shell-parser command substitution fallback', () => {
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should not flag a benign $() that the grammar parses correctly', () => {
  ...
  {
    const it = !parserInitialized ? bunIt.skip : bunIt;
    it('should flag malformed substitution syntax that bypasses the AST', () => {
