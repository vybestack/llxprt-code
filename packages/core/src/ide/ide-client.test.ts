...
describe('IdeClient.validateWorkspacePath', () => {
  it('should return valid if cwd is a subpath of the IDE workspace path', () => {
    const result = IdeClient.validateWorkspacePath(
      '/Users/person/llxprt-code',
      'VS Code',
      '/Users/person/llxprt-code/sub-dir',
    );
    expect(result.isValid).toBe(true);
  });

  it('should return invalid if LLXPRT_CODE_IDE_WORKSPACE_PATH is undefined', () => {
    const result = IdeClient.validateWorkspacePath(
      undefined,
      'VS Code',
      '/Users/person/llxprt-code/sub-dir',
  ...
  it('should return invalid if LLXPRT_CODE_IDE_WORKSPACE_PATH is empty', () => {
    const result = IdeClient.validateWorkspacePath(
      '',
      'VS Code',
      '/Users/person/llxprt-code/sub-dir',
  ...
  it('should handle multiple workspace paths and return valid', () => {
    const result = IdeClient.validateWorkspacePath(
      ['/some/other/path', '/Users/person/llxprt-code'].join(path.delimiter),
      'VS Code',
      '/Users/person/llxprt-code/sub-dir',
    );
    expect(result.isValid).toBe(true);
