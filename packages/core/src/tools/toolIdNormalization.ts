...
/**
 * Core-owned shared utility for normalizing tool IDs between provider formats
 * and history format.
 *
 * Moved from providers/utils/toolIdNormalization.ts to this core-owned path.
 * Both core and provider code import this utility from the core location.
 *
