...
const mockExtensions = [
  { name: 'ext-one', version: '1.0.0', isActive: true, contextFiles: [] },
  { name: 'ext-two', version: '2.1.0', isActive: true, contextFiles: [] },
  { name: 'ext-disabled', version: '3.0.0', isActive: false, contextFiles: [] },
];
