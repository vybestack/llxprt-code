...
import { AnsiOutput } from '@vybestack/llxprt-code-core';
...
export const ToolResultDisplay: React.FC<ToolResultDisplayProps> = ({
  ...
  // const { renderMarkdown } = useUIState(); // renderMarkdown is not in UIState
  // const renderMarkdown = true; // Default to true or pass as prop if needed
        ...
        renderOutputAsMarkdown ? (
          <Box flexDirection="column">
            <MarkdownDisplay
              ...
              // renderMarkdown={renderMarkdown} // Not a prop of MarkdownDisplay
              isPending={false}
            />
          </Box>
        ) : typeof truncatedResultDisplay === 'string' &&
          ...
          <AnsiOutputText
            ...
            availableTerminalHeight={availableHeight}
            // width={childWidth} // Not a prop of AnsiOutputText
          />
        )}
      </Box>
    </Box>
