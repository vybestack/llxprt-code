...
export const initCommand: SlashCommand = {
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are an AI agent that brings the power of multiple LLM providers directly into the terminal. Your task is to analyze the current directory and generate a comprehensive LLXPRT.md file to be used as instructional context for future interactions.
