...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific AI model for conversations (/settings)...',
  ...
  'Toggle respect for .llxprtignore files in context (/settings)...',
  ...
  'Show LLxprt Code status in the terminal window title (/settings)...',
  ...
  'Create a project-specific LLXPRT.md file with /init...',
  ...
  'Reload instructional context from LLXPRT.md files with /memory refresh...',
  'List the paths of the LLXPRT.md files in use with /memory list...',
  'Choose your AI model with /model...',
