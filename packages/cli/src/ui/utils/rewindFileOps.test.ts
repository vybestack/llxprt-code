...
describe('rewindFileOps', () => {
  ...
  describe('calculateTurnStats', () => {
    it('returns null if no edits found after user message', () => {
      const userMsg: BaseMessageRecord = {
        type: 'user',
        role: 'user' as const,
        content: 'hello',
        id: '1',
    ...
    it('calculates stats for single turn correctly', () => {
      ...
      const toolMsg: BaseMessageRecord = {
        type: 'gemini',
        role: 'model' as const,
        id: '2',
        timestamp: '2',
      ...
      const userMsg2: BaseMessageRecord = {
        type: 'user',
        role: 'user' as const,
        content: 'next',
        id: '3',
  ...
  describe('calculateRewindImpact', () => {
    it('calculates cumulative stats across multiple turns', () => {
      const userMsg1: BaseMessageRecord = {
        type: 'user',
        role: 'user' as const,
        content: 'start',
        id: '1',
      ...
      const toolMsg1: BaseMessageRecord = {
        type: 'gemini',
        role: 'model' as const,
        id: '2',
        timestamp: '2',
      ...
      const toolMsg2: BaseMessageRecord = {
        type: 'gemini',
        role: 'model' as const,
        id: '4',
        timestamp: '4',
