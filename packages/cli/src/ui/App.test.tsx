...
describe('App UI', () => {
  ...
  describe('handleAutoUpdate', () => {
    ...
    afterEach(() => {
      delete process.env.LLXPRT_CLI_DISABLE_AUTOUPDATER;
    });
    ...
    it('should not start the update process when running from git', async () => {
      ...
      const info: UpdateObject = {
        ...
        message: 'LLxprt Code update available!',
      };
    ...
    it('should not auto-update if LLXPRT_CLI_DISABLE_AUTOUPDATER is true', async () => {
      mockedIsGitRepository.mockResolvedValue(false);
      process.env.LLXPRT_CLI_DISABLE_AUTOUPDATER = 'true';
      const info: UpdateObject = {
        update: {
          name: '@vybestack/llxprt-code',
          latest: '1.1.0',
  ...
  it('should display active file and other context', async () => {
    ...
    await Promise.resolve();
    expect(lastFrame()).toContain(
      'Using: 1 open file (ctrl+g to view) | 1 LLXPRT.md file',
    );
  });
  ...
  describe('auth validation', () => {
    it('should call validateAuthMethod when useExternalAuth is false', async () => {
      ...
      expect(validateAuthMethodSpy).toHaveBeenCalledWith('USE_PROVIDER');
    });
