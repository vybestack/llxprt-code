...
LLxprt Code extension. It demonstrates how to expose tools and prompts to
LLxprt Code.
...
- `gemini-extension.json`: The configuration file that tells LLxprt Code how to
  use this extension.
...
This example is typically used by `llxprt extensions new`.
