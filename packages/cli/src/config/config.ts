...
import type { CliArgs } from './parseArguments.js';
...
// Re-export for backward compatibility (test imports from '../config.js')
export { READ_ONLY_TOOL_NAMES };

// Re-export parseArguments and CliArgs for backward compatibility
export { parseArguments, type CliArgs } from './parseArguments.js';
