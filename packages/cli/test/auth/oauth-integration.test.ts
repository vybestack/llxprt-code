...
describe.skipIf(skipInCI)(
  'OAuth Integration Tests - Provider Registration & Initialization',
  () => {
    ...
    describe.skipIf(skipInCI)(
      'Authentication Status and Token Persistence',
      () => {
        beforeEach(() => {
        ...
        it('should correctly report authentication status for all providers', async () => {
          ...
          const geminiStatus = authStatuses.find(
            (s) => s.provider === 'gemini',
          );
    ...
    describe.skipIf(skipInCI)('OAuth Enablement State Management', () => {
      beforeEach(() => {
        oauthManager.registerProvider(new QwenOAuthProvider(tokenStore));
        oauthManager.registerProvider(new GeminiOAuthProvider(tokenStore));
      });
...
describe.skipIf(skipInCI)(
  'OAuth Integration Tests - Logout and Cache Clearing',
  () => {
    let tokenStore: TestTokenStore;
    let mockSettings: MockSettings;
    let oauthManager: OAuthManager;
    ...
    describe.skipIf(skipInCI)('Security Fix: OAuth Cache Clearing', () => {
    ...
    describe.skipIf(skipInCI)('Comprehensive Logout Scenarios', () => {
      ...
      it('should handle logoutAll with mixed authentication states', async () => {
        ...
        const geminiAuthenticated =
          await oauthManager.isAuthenticated('gemini');
...
describe.skipIf(skipInCI)(
  'OAuth Integration Tests - Concurrent Operations & Race Conditions',
  () => {
    let tokenStore: TestTokenStore;
    let oauthManager: OAuthManager;
    ...
    describe.skipIf(skipInCI)('Async Initialization Race Conditions', () => {
    ...
    describe.skipIf(skipInCI)('Concurrent Provider Operations', () => {
...
describe.skipIf(skipInCI)(
  'OAuth Integration Tests - Error Handling & Recovery',
  () => {
    let tokenStore: TestTokenStore;
    let oauthManager: OAuthManager;
    ...
    describe.skipIf(skipInCI)('Storage Error Scenarios', () => {
    ...
    describe.skipIf(skipInCI)('Token Validation and Expiry Scenarios', () => {
    ...
    describe.skipIf(skipInCI)('Provider-Specific Error Scenarios', () => {
...
describe.skipIf(skipInCI)(
  'OAuth Integration Tests - Memory-Only Mode & Settings Compatibility',
  () => {
    let tokenStore: TestTokenStore;
    ...
    describe.skipIf(skipInCI)('Memory-Only Operation (No Settings)', () => {
    ...
    describe.skipIf(skipInCI)('Precedence Resolution Integration', () => {
