...
describe('OAuthManager - Logout Single Provider (REQ-002)', () => {
...
describe('OAuthManager - Logout All Providers (REQ-002)', () => {
  let tokenStore: MultiProviderTokenStore;
  let oauthManager: OAuthManager;
  ...
  it('should update authentication status for all providers after logoutAll', async () => {
    ...
    const beforeAnthropicAuth = await oauthManager.isAuthenticated('anthropic');
    ...
    const afterAnthropicAuth = await oauthManager.isAuthenticated('anthropic');
...
describe('OAuthManager - Logout Error Handling (REQ-002)', () => {
  let tokenStore: MultiProviderTokenStore;
  let oauthManager: OAuthManager;
...
describe('OAuthManager - Logout Property-Based Tests', () => {
  let tokenStore: MultiProviderTokenStore;
  let oauthManager: OAuthManager;
