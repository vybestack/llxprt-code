...
describe.skipIf(skipInCI)(
  'QwenOAuthProvider - Token Persistence (REQ-001)',
  () => {
...
describe.skipIf(skipInCI)(
  'QwenOAuthProvider - Logout Functionality (REQ-002)',
  () => {
    let tokenStore: MultiProviderTokenStore;
    let provider: QwenOAuthProvider;
...
describe.skipIf(skipInCI)(
  'QwenOAuthProvider - Token Lifecycle (REQ-003)',
  () => {
    let tokenStore: MultiProviderTokenStore;
    let provider: QwenOAuthProvider;
...
describe.skipIf(skipInCI)('QwenOAuthProvider - Integration (REQ-004)', () => {
  let tokenStore: MultiProviderTokenStore;
  let provider: QwenOAuthProvider;
...
describe.skipIf(skipInCI)('QwenOAuthProvider - Property-Based Tests', () => {
  let tokenStore: MultiProviderTokenStore;
  let provider: QwenOAuthProvider;
