...
describe('AnthropicOAuthProvider - Token Persistence (REQ-001)', () => {
...
describe('AnthropicOAuthProvider - Logout Functionality (REQ-002)', () => {
  let tokenStore: MultiProviderTokenStore;
  let provider: AnthropicOAuthProvider;
...
describe('AnthropicOAuthProvider - Token Lifecycle (REQ-003)', () => {
  let tokenStore: MultiProviderTokenStore;
  let provider: AnthropicOAuthProvider;
...
describe('AnthropicOAuthProvider - Integration (REQ-004)', () => {
  let tokenStore: MultiProviderTokenStore;
  let provider: AnthropicOAuthProvider;
...
describe('AnthropicOAuthProvider - Property-Based Tests', () => {
  let tokenStore: MultiProviderTokenStore;
  let provider: AnthropicOAuthProvider;
