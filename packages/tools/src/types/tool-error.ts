...
/**
 * Package-local tool error type enum.
 *
 * Type-safe enum for tool-related errors, categorized as:
 * - Recoverable: LLM can self-correct (e.g., invalid params, file not found)
 * - Fatal: System-level issues preventing continued execution
 *
 ...
 * @returns true if the error should cause the CLI to exit.
 */
