...
describe('AgentClient - Runtime State Integration', () => {
  /**
   * @plan PLAN-20251027-STATELESS5.P09
   * @requirement REQ-STAT5-003.1
   * @pseudocode gemini-runtime.md lines 18-60
   *
   * Test: AgentClient constructor accepts AgentRuntimeState
   */
   ...
   *
   * Test: AgentClient uses runtime state for provider/model/auth
   */
