...
/**
 * @fileoverview Hard-limit context-window enforcement extracted from
 * CompressionHandler.enforceContextWindow. Enforces the provider context
 * window by orchestrating density optimization, compression, fallback
 * truncation, and last-resort tool-response truncation, throwing a
 * structured context-overflow error when all reduction paths fail.
 *
