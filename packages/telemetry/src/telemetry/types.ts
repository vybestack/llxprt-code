 ...
 */
/* eslint-disable max-lines -- Mirrors the existing telemetry event public API in a compatibility module. */
...
/**
 * The DEFAULT_AGENT_ID constant. Kept in telemetry to avoid
 * importing from core.
 */
