...
function createSuccessorInstallingLink(
  fencePath: string,
  lockPath: string,
  successor: Awaited<ReturnType<typeof buildCurrentProcessOwnerMetadata>>,
  originalLink: typeof fs.link,
): typeof fs.link {
