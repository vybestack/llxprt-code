...
// These smoke tests exercise the REAL OS keyring end to end. Uniform test
// isolation (issue #3622) sets LLXPRT_TEST_DISABLE_OS_KEYRING=1 in every
// preload by default. An explicit empty value or 0 opts into native access
