...
TEST_FILE_NAME="run_shell_command.qwen-script-call.test.js"
...
# Execute the Qwen script-call integration test
node --test integration-tests/run_shell_command.qwen-script-call.test.js
