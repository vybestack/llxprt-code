...
- Architecture, settings, CLI, core runtime, and migration documents were promoted from stubs to full guidance aligned with the stateless provider architecture.
