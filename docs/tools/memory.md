...
The tool appends the provided `fact` to a special `AGENT.md` file located in the user's home directory (`~/.llxprt/AGENT.md`). This file can be configured to have a different name.
