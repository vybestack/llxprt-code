...
> **Free individual access removed in mid-2026.** Google has fully removed the free consumer "Login with Google" CLI access. OAuth and the project/Vertex/ADC methods below continue to work for **Gemini API keys** and **Google Workspace** accounts. For individual use, set a Gemini API key or use one of the Google Cloud methods on this page.
