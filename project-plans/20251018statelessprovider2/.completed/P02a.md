Phase: P02a
Completed: 2025-10-18 18:55:24 -03
Verification:
...
> vitest run --run provider-multi-runtime
 ...
 ❯ src/integration-tests/provider-multi-runtime.integration.test.ts (2 tests | 2 failed) 101ms
   × provider multi-runtime guardrails > restores runtime-scoped provider manager isolation @plan:PLAN-20251018-STATELESSPROVIDER2.P02 @requirement:REQ-SP2-002 93ms
     → expected 'cerebrasqwen3' to be 'zai' // Object.is equality
   × provider multi-runtime guardrails > keeps provider mutations scoped to active runtime @plan:PLAN-20251018-STATELESSPROVIDER2.P02 @requirement:REQ-SP2-002 8ms
     → promise rejected "Error: Active provider not found" instead of resolving
...
Received: [31m"cerebrasqwen3"[39m
 ...
 ❯ src/integration-tests/provider-multi-runtime.integration.test.ts:92:56
     90|     // Guardrail: runtime A should surface its own provider manager re…
     91|     // TODO(P03): This currently fails because CLI caches providerMana…
...
AssertionError: promise rejected "Error: Active provider not found" instead of resolving
 ❯ src/integration-tests/provider-multi-runtime.integration.test.ts:126:5
    124|     await expect(
    125|       switchActiveProvider(runtimeA.profile.provider),
    126|     ).resolves.toMatchObject({ nextProvider: runtimeA.profile.provider…
       |     ^
    127|   });
    128| });

Caused by: Error: Active provider not found
 ❯ ProviderManager.getActiveProvider ../core/src/providers/ProviderManager.ts:326:13
 ❯ Config.setEphemeralSetting ../core/src/config/config.ts:1181:53
 ❯ switchActiveProvider src/runtime/runtimeSettings.ts:750:12
 ❯ src/integration-tests/provider-multi-runtime.integration.test.ts:125:7
