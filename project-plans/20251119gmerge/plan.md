...
| 3 | 899b6f72, a34e3751, 1f31443e, ec0acc48, ~~22b7d865~~ | ✅ Completed | #38 ANSI refactor landed as e20d7f1e9. Skipped #44 (auto-update extensions) due to complex conflicts. | Auto-update functionality reimplemented via `ExtensionAutoUpdater` (packages/cli/src/extensions/extensionAutoUpdater.ts). |
...
| 7 | a1dc7a8f, b4455af3, 8fdb61aa, ~~d9828e25~~, ~~6869dbe6~~ | ✅ Completed | Comma-separated extensions, positional prompt fix, IDE discovery. #123 skipped (needs auto-update infra), #124 conflict-heavy. | Extension update infrastructure now covered by the new auto-update implementation (`packages/cli/src/extensions/extensionAutoUpdater.ts`). |
| 8 | 81d03cb5, 9abb165f, ~~34c14b7d~~, ~~6c559e23~~, 710e00e0 | ✅ Completed | BaseSelectionList extraction, VSIX size optimization, GitHub release artifacts. #130 skipped (install metadata conflicts), #133 marked for reimplementation. | #133 permissions command reimplemented via `/permissions` dialog (2025-11-21). |
