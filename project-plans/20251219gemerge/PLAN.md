...
- `project-plans/20251219gemerge/CHERRIES.md`
- `project-plans/20251219gemerge/SUMMARY.md`
...
|---:|:---|:---|:---|:---|:---|
| 01 | REIMPLEMENT | `b8df8b2a` | `project-plans/20251219gemerge/b8df8b2a-plan.md` | `reimplement: feat(core): wire up UI for ASK_USER policy decisions in message bus (#10630) (upstream b8df8b2a)` | QUICK |
...
| 04 | REIMPLEMENT | `130f0a02` | `project-plans/20251219gemerge/130f0a02-plan.md` | `reimplement: chore(subagents): Remove legacy subagent code (#11175) (upstream 130f0a02)` | FULL |
| 05 | REIMPLEMENT | `c9c633be` | `project-plans/20251219gemerge/c9c633be-plan.md` | `reimplement: refactor: move `web_fetch` tool name to `tool-names.ts` (#11174) (upstream c9c633be)` | QUICK |
...
| 07 | REIMPLEMENT | `05930d5e` | `project-plans/20251219gemerge/05930d5e-plan.md` | `reimplement: fix(web-fetch): respect Content-Type header in fallback mechanism (#11284) (upstream 05930d5e)` | QUICK |
| 08 | PICK | `6ded45e5, d2c9c5b3` | `git cherry-pick 6ded45e5 d2c9c5b3` | `cherry-pick: upstream 6ded45e5..d2c9c5b3 batch 08` | FULL |
| 09 | REIMPLEMENT | `937c15c6` | `project-plans/20251219gemerge/937c15c6-plan.md` | `reimplement: refactor: Remove deprecated --all-files flag (#11228) (upstream 937c15c6)` | QUICK |
...
| 11 | REIMPLEMENT | `9049f8f8` | `project-plans/20251219gemerge/9049f8f8-plan.md` | `reimplement: feat: remove deprecated telemetry flags (#11318) (upstream 9049f8f8)` | QUICK |
| 12 | PICK | `22f725eb` | `git cherry-pick 22f725eb` | `cherry-pick: upstream 22f725eb..22f725eb batch 12` | FULL |
| 13 | REIMPLEMENT | `dcf362bc` | `project-plans/20251219gemerge/dcf362bc-plan.md` | `reimplement: Inline tree-sitter wasm and add runtime fallback (#11157) (upstream dcf362bc)` | QUICK |
...
| 19 | REIMPLEMENT | `08e87a59` | `project-plans/20251219gemerge/08e87a59-plan.md` | `reimplement: Log all user settings to enable measurement of experiment impacts (#11354) (upstream 08e87a59)` | QUICK |
| 20 | PICK | `21163a16` | `git cherry-pick 21163a16` | `cherry-pick: upstream 21163a16..21163a16 batch 20` | FULL |
| 21 | REIMPLEMENT | `9b9ab609` | `project-plans/20251219gemerge/9b9ab609-plan.md` | `reimplement: feat(logging): Centralize debug logging with a dedicated utility (#11417) (upstream 9b9ab609)` | QUICK |
| 22 | REIMPLEMENT | `f4330c9f` | `project-plans/20251219gemerge/f4330c9f-plan.md` | `reimplement: remove support for workspace extensions and migrations (#11324) (upstream f4330c9f)` | FULL |
...
| 26 | REIMPLEMENT | `f22aa72c` | `project-plans/20251219gemerge/f22aa72c-plan.md` | `reimplement: Making shell:true as default and adding -I to  grep (#11448) (upstream f22aa72c)` | FULL |
| 27 | PICK | `d065c3ca` | `git cherry-pick d065c3ca` | `cherry-pick: upstream d065c3ca..d065c3ca batch 27` | QUICK |
| 28 | REIMPLEMENT | `98eef9ba` | `project-plans/20251219gemerge/98eef9ba-plan.md` | `reimplement: fix: Update web_fetch tool definition to instruct the model to provid… (#11252) (upstream 98eef9ba)` | FULL |
...
| 31 | REIMPLEMENT | `c8518d6a` | `project-plans/20251219gemerge/c8518d6a-plan.md` | `reimplement: refactor(tools): Move all tool names into tool-names.ts (#11493) (upstream c8518d6a)` | QUICK |
| 32 | REIMPLEMENT | `8731309d` | `project-plans/20251219gemerge/8731309d-plan.md` | `reimplement: chore: do not retry the model request if the user has aborted the request (#11224) (upstream 8731309d)` | FULL |
...
| 34 | REIMPLEMENT | `36de6862` | `project-plans/20251219gemerge/36de6862-plan.md` | `reimplement: feat: Propagate traceId from code assist to response metadata (Fixes … (#11360) (upstream 36de6862)` | FULL |
...
| 36 | REIMPLEMENT | `995ae717` | `project-plans/20251219gemerge/995ae717-plan.md` | `reimplement: refactor(logging): Centralize all console messaging to a shared logger (part 1) (#11537) (upstream 995ae717)` | FULL |
| 37 | REIMPLEMENT | `cc7e1472` | `project-plans/20251219gemerge/cc7e1472-plan.md` | `reimplement: Pass whole extensions rather than just context files (#10910) (upstream cc7e1472)` | QUICK |
...
| 39 | REIMPLEMENT | `7dd2d8f7` | `project-plans/20251219gemerge/7dd2d8f7-plan.md` | `reimplement: fix(tools): restore static tool names to fix configuration exclusions (#11551) (upstream 7dd2d8f7)` | QUICK |
| 40 | PICK | `654c5550, 0658b4aa` | `git cherry-pick 654c5550 0658b4aa` | `cherry-pick: upstream 654c5550..0658b4aa batch 40` | FULL |
| 41 | REIMPLEMENT | `bf80263b` | `project-plans/20251219gemerge/bf80263b-plan.md` | `reimplement: feat: Implement message bus and policy engine (#11523) (upstream bf80263b)` | QUICK |
...
| 43 | REIMPLEMENT | `dd3b1cb6` | `project-plans/20251219gemerge/dd3b1cb6-plan.md` | `reimplement: feat(cli): continue request after disabling loop detection (#11416) (upstream dd3b1cb6)` | QUICK |
| 44 | REIMPLEMENT | `b364f376` | `project-plans/20251219gemerge/b364f376-plan.md` | `reimplement: refactor(logging): Centralize console logging with debugLogger (#11590) (upstream b364f376)` | FULL |
