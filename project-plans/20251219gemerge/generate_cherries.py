...
Inputs:
  - project-plans/20251219gemerge/upstream-0.10.0..0.11.3.json
...
DATA_PATH = ROOT / "project-plans/20251219gemerge/upstream-0.10.0..0.11.3.json"
OUT_CHERRIES = ROOT / "project-plans/20251219gemerge/CHERRIES.md"
OUT_SUMMARY = ROOT / "project-plans/20251219gemerge/SUMMARY.md"
...
def main() -> None:
    ...
    summary_lines += [
        ...
        "- Plan folder: project-plans/20251219gemerge/",
    ]
