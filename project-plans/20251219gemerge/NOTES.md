...
M packages/core/src/tools/google-web-fetch.ts
M packages/core/src/tools/tools.ts
M project-plans/20251219gemerge/AUDIT.md
M project-plans/20251219gemerge/NOTES.md
M project-plans/20251219gemerge/PROGRESS.md

$ git commit -m "reimplement: feat(core): wire up UI for ASK_USER policy decisions in message bus (upstream b8df8b2a)"
[20251219gemerge 27ef2ae40] reimplement: feat(core): wire up UI for ASK_USER policy decisions in message bus (upstream b8df8b2a)
...
To https://github.com/vybestack/llxprt-code.git
   822791454..27ef2ae40  20251219gemerge -> 20251219gemerge
```
