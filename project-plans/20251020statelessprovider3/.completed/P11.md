@plan:PLAN-20251020-STATELESSPROVIDER3.P11

Initiated OAuth safety TDD by confirming Phase P10a completion, adding the safety regression tests for `unwrapLoggingProvider`, and running the targeted `vitest` suite to capture the expected RED-stage failure output ahead of implementation.

Prerequisite confirmation:
```bash
ls project-plans/20251020statelessprovider3/.completed/P10a.md
```
```text
project-plans/20251020statelessprovider3/.completed/P10a.md
```
...
Failing stderr (NotYetImplemented placeholder still active):
```text
