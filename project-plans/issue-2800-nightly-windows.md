...
| **Total** | **60 paths** | **+3062 / -1855 (net +1207)** | **User-approved expansion above the 40-path hard stop; net remains below 2500.** |
...
40-path hard stop. The resulting diff has 60 paths, 3,062 additions, and 1,855
deletions, for net +1,207. The path expansion is approved and the net line total
