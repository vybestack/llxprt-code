...
| **Total** | **61 paths** | **+3089 / -1863 (net +1226)** | **User-approved expansion above the 40-path hard stop; net remains below 2500.** |
...
40-path hard stop. The resulting diff has 61 paths, 3,089 additions, and 1,863
deletions, for net +1,226. The path expansion is approved and the net line total
