...
| **Total** | **60 paths** | **+3004 / -1737 (net +1267)** | **User-approved expansion above the 40-path hard stop; net remains below 2500.** |
...
40-path hard stop. The resulting diff has 60 paths, 3,004 additions, and 1,737
deletions, for net +1,267. The path expansion is approved and the net line total
