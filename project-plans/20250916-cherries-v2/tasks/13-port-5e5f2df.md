# Task 13 – PORT 5e5f2dff

**Task Type:** PORT\n**Area:** trust\n**Risk Level:** low\n**Results File:** `project-plans/20250916-cherries-v2/results/task-13.md`\n
## Commit Details
- Upstream hash: `5e5f2dff`
- Description: Respect folder trust setting when reading GEMINI.md
- Rationale: File reading (change GEMINI.md references)

## Execution Steps
1. Cherry-pick the commit with metadata preserved:
   ```bash
   git cherry-pick -x 5e5f2dff
   ```
...
3. Capture upstream and local diffs in `project-plans/20250916-cherries-v2/results/task-13.md` using the template.
4. Run the automated quality gate (fails stop progress):
   ```bash
   ./project-plans/20250916-cherries-v2/run-quality-gates.sh project-plans/20250916-cherries-v2/results/task-13.md
   ```
...
7. Ask Claude to run the Codex audit (10-minute shell timeout):
   ...
   codex exec "Evaluate the cherry-pick task results in project-plans/20250916-cherries-v2/results/task-13.md. Check:
     ...
     3. Did the quality gate script pass? Check the log file at project-plans/20250916-cherries-v2/.quality-logs/task-13 for any failures.
