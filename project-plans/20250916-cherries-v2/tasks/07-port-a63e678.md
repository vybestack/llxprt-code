# Task 07 – PORT a63e6782

**Task Type:** PORT\n**Area:** ui\n**Risk Level:** medium\n**Results File:** `project-plans/20250916-cherries-v2/results/task-07.md`\n
## Commit Details
- Upstream hash: `a63e6782`
- Description: Add Pro Quota Dialog
- Rationale: Interactive quota handling (create provider-aware quota dialog)

## Execution Steps
1. Cherry-pick the commit with metadata preserved:
   ```bash
   git cherry-pick -x a63e6782
   ```
...
3. Capture upstream and local diffs in `project-plans/20250916-cherries-v2/results/task-07.md` using the template.
4. Run the automated quality gate (fails stop progress):
   ```bash
   ./project-plans/20250916-cherries-v2/run-quality-gates.sh project-plans/20250916-cherries-v2/results/task-07.md
   ```
...
7. Ask Claude to run the Codex audit (10-minute shell timeout):
   ...
   codex exec "Evaluate the cherry-pick task results in project-plans/20250916-cherries-v2/results/task-07.md. Check:
     ...
     3. Did the quality gate script pass? Check the log file at project-plans/20250916-cherries-v2/.quality-logs/task-07 for any failures.
