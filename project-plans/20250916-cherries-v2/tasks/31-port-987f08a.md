# Task 31 – PORT 987f08a6

**Task Type:** PORT\n**Area:** auth\n**Risk Level:** medium\n**Results File:** `project-plans/20250916-cherries-v2/results/task-31.md`\n
## Commit Details
- Upstream hash: `987f08a6`
- Description: Add enforcedAuthType setting
- Rationale: Auth enforcement (adapt for multi-provider)

## Execution Steps
1. Cherry-pick the commit with metadata preserved:
   ```bash
   git cherry-pick -x 987f08a6
   ```
...
3. Capture upstream and local diffs in `project-plans/20250916-cherries-v2/results/task-31.md` using the template.
4. Run the automated quality gate (fails stop progress):
   ```bash
   ./project-plans/20250916-cherries-v2/run-quality-gates.sh project-plans/20250916-cherries-v2/results/task-31.md
   ```
...
7. Ask Claude to run the Codex audit (10-minute shell timeout):
   ...
   codex exec "Evaluate the cherry-pick task results in project-plans/20250916-cherries-v2/results/task-31.md. Check:
     ...
     3. Did the quality gate script pass? Check the log file at project-plans/20250916-cherries-v2/.quality-logs/task-31 for any failures.
