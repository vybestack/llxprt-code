# Phase 04a: Core contract test verification

## Phase ID

PLAN-20260603-ISSUE1584.P04a
...
### REQ-TEST-001: Core contract test verification

**Full Text**: Tests MUST avoid reverse testing, mock theater, and tests that only validate structure.
**Behavior**:
- GIVEN: P04 tests exist
- WHEN: reviewer reads assertions and runs targeted tests to confirm natural failure
- THEN: test quality issues are fixed before implementation
...
### Files to Create
- project-plans/issue1584/.completed/P04a.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P04a
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P04a" packages
...
Create project-plans/issue1584/.completed/P04a.md with files changed, tests added, verification outputs, and holistic functionality assessment.
