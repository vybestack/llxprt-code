...
### REQ-API-001: Integration contract verification

**Full Text**: Existing provider runtime behavior MUST remain reachable through current CLI commands and startup flows.
**Behavior**:
- GIVEN: integration contract exists
- WHEN: reviewer validates existing files and call paths cited by contract
- THEN: unreachable or isolated plan parts are rejected
...
### Files to Create
- project-plans/issue1584/.completed/P02c.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P02c
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P02c" packages
...
Create project-plans/issue1584/.completed/P02c.md with files changed, tests added, verification outputs, and holistic functionality assessment.
