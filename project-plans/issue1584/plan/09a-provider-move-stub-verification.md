# Phase 09a: Provider move stub verification

## Phase ID

PLAN-20260603-ISSUE1584.P09a
...
### REQ-PKG-001: Provider move stub verification
...
**Behavior**:
- GIVEN: P09 map exists
- WHEN: reviewer verifies map covers all provider files and does not skip tests/docs/fixtures
- THEN: P10 can test the move comprehensively
...
### Files to Create
- project-plans/issue1584/.completed/P09a.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P09a
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P09a" packages
...
Create project-plans/issue1584/.completed/P09a.md with files changed, tests added, verification outputs, and holistic functionality assessment.
