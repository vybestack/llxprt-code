# Phase 12a: Consumer migration stub verification
...
### REQ-API-001: Consumer migration stub verification

**Full Text**: packages/core/src/index.ts MUST remove provider implementation exports and MUST NOT re-export providers from the new package.
**Behavior**:
- GIVEN: P12 edits exist
- WHEN: reviewer confirms no core shim and no skipped consumer categories
- THEN: P13 can write integration tests
...
### Files to Create
- project-plans/issue1584/.completed/P12a.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P12a
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P12a" packages
...
Create project-plans/issue1584/.completed/P12a.md with files changed, tests added, verification outputs, and holistic functionality assessment.
