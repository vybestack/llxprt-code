# Phase 07a: Provider package scaffold test verification

## Phase ID

PLAN-20260603-ISSUE1584.P07a
...
### REQ-TEST-001: Provider package scaffold test verification

**Full Text**: Tests MUST avoid reverse testing, mock theater, and tests that only validate structure.
**Behavior**:
- GIVEN: P07 tests exist
- WHEN: reviewer verifies tests fail/pass for meaningful reasons and do not assert stubs
- THEN: tests are accepted before implementation
...
### Files to Create
- project-plans/issue1584/.completed/P07a.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P07a
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P07a" packages
...
Create project-plans/issue1584/.completed/P07a.md with files changed, tests added, verification outputs, and holistic functionality assessment.
