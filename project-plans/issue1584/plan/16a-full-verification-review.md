...
### REQ-CLEAN-001: Final semantic review

**Full Text**: Full verification suite required by project memory MUST pass before PR.
**Behavior**:
- GIVEN: P16 command outputs exist
- WHEN: typescriptreviewer performs holistic review of issue intent, plan compliance, behavior, and boundaries
- THEN: remaining issues are fixed before commit/PR
...
### Files to Create
- project-plans/issue1584/.completed/P16a.md

### Review Must Check
- Issue #1584 acceptance criteria.
- Parent #1568 no-shim requirement.
- PLAN.md / PLAN-TEMPLATE.md / RULES.md compliance.
- Full command outputs from P16.
- CodeRabbit plan pitfalls were avoided.
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P16a" packages
...
Create project-plans/issue1584/.completed/P16a.md with files changed, tests added, verification outputs, and holistic functionality assessment.
