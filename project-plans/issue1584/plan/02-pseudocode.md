...
### REQ-TEST-001: Contract-first pseudocode
...
**Behavior**:
- GIVEN: analysis artifacts exist
- WHEN: pseudocode is written or updated
- THEN: implementation phases can reference exact pseudocode lines
...
- project-plans/issue1584/analysis/pseudocode/package-boundary.md
- project-plans/issue1584/analysis/pseudocode/consumer-migration.md
- project-plans/issue1584/analysis/pseudocode/verification.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P02
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P02" packages
...
Create project-plans/issue1584/.completed/P02.md with files changed, tests added, verification outputs, and holistic functionality assessment.
