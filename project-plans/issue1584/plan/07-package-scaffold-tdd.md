# Phase 07: Provider package scaffold tests

## Phase ID

PLAN-20260603-ISSUE1584.P07
...
### REQ-PKG-001: Provider package scaffold tests

**Full Text**: packages/providers MUST expose a clean public API through @vybestack/llxprt-code-providers.
**Behavior**:
- GIVEN: P06 scaffold exists
- WHEN: tests/scripts assert workspace metadata, package name, entry point, and build behavior
- THEN: tests fail naturally until scaffold implementation is complete
...
- Package-boundary tests or repository verification script under existing test conventions.
- Tests must verify actual package metadata values and importability, not only file existence.
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P07" packages
...
Create project-plans/issue1584/.completed/P07.md with files changed, tests added, verification outputs, and holistic functionality assessment.
