# Phase 03a: Core-owned contract stub verification

## Phase ID

PLAN-20260603-ISSUE1584.P03a
...
### REQ-DEP-001: Core-owned contract stub verification

**Full Text**: Production package dependencies MUST NOT form a core/providers cycle.
**Behavior**:
- GIVEN: P03 changed files exist
- WHEN: reviewer verifies stubs compile and are not parallel implementations
- THEN: P04 can write behavioral tests against the intended contracts
...
### Files to Create
- project-plans/issue1584/.completed/P03a.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P03a
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P03a" packages
...
Create project-plans/issue1584/.completed/P03a.md with files changed, tests added, verification outputs, and holistic functionality assessment.
