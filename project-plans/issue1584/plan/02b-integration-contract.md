...
### REQ-API-001: Integration contract definition

**Full Text**: Existing provider runtime behavior MUST remain reachable through current CLI commands and startup flows.
**Behavior**:
- GIVEN: analysis and pseudocode are complete
- WHEN: integration contract is refined with exact caller/callee boundaries
- THEN: implementation phases have reachable integration targets
...
### Files to Modify
- project-plans/issue1584/analysis/integration-contract.md
...
```typescript
/**
 * @plan:PLAN-20260603-ISSUE1584.P02b
...
```bash
rg -n "@plan:PLAN-20260603-ISSUE1584.P02b" packages
...
Create project-plans/issue1584/.completed/P02b.md with files changed, tests added, verification outputs, and holistic functionality assessment.
