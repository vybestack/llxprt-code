...
| 35 | `packages/core/src/providers/ProviderManager.gemini-switch.test.ts` | `plugins/google-gemini/src/test/ProviderManager.gemini-switch.test.ts` | Plugin-owned override (#2762) | B |
